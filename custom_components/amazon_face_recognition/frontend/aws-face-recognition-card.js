      ...
      <ha-card>
        <div class="card">
          ...
          <div class="controls">
            ...
            <div class="btnrow" style="gap:10px; justify-content:center; flex: 1;">
              ${this._scale>1?yt`
                    <!--
            ...
            <div class="toolgroup" role="group" aria-label="Actions">
              <button
                class="iconbtn"
